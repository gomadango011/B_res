...
AodvExample::CreateNodes ()
{
  ...
  AnimationInterface::SetConstantPosition (nodes.Get (2), 160, 10);//WH2
  AnimationInterface::SetConstantPosition (nodes.Get (3), 40, -10);
  AnimationInterface::SetConstantPosition (nodes.Get (4), 80, -10);
  AnimationInterface::SetConstantPosition (nodes.Get (5), 120, -10);
  AnimationInterface::SetConstantPosition (nodes.Get (6), 160, -10);
  AnimationInterface::SetConstantPosition (nodes.Get (7), 200, -10);
  AnimationInterface::SetConstantPosition (nodes.Get (8), 240, 0);
