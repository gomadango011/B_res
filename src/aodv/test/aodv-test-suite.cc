...
struct AodvRtableEntryTest : public TestCase
{
  ...
  virtual void DoRun ()
  {
    ...
    RoutingTableEntry rt (/*output device*/ dev, /*dst*/ Ipv4Address ("1.2.3.4"), /*validSeqNo*/ true, /*seqNo*/ 10,
                                            /*interface*/ iface, /*hop*/ 5, /*next hop*/ Ipv4Address ("3.3.3.3"), /*secondhop*/Ipv4Address(),/*lifetime*/ Seconds (10));
...
struct AodvRtableTest : public TestCase
{
  ...
  virtual void DoRun ()
  {
    ...
    Ipv4InterfaceAddress iface;
    RoutingTableEntry rt (/*output device*/ dev, /*dst*/ Ipv4Address ("1.2.3.4"), /*validSeqNo*/ true, /*seqNo*/ 10,
                                            /*interface*/ iface, /*hop*/ 5, /*next hop*/ Ipv4Address ("1.1.1.1"), /*second hop*/Ipv4Address(), /*lifetime*/ Seconds (10));
    ...
    RoutingTableEntry rt2 (/*output device*/ dev, /*dst*/ Ipv4Address ("4.3.2.1"), /*validSeqNo*/ false, /*seqNo*/ 0,
                                             /*interface*/ iface, /*hop*/ 15, /*next hop*/ Ipv4Address ("1.1.1.1"), /*second hop*/Ipv4Address(), /*lifetime*/ Seconds (1));
    ...
    RoutingTableEntry rt4 (/*output device*/ dev, /*dst*/ Ipv4Address ("5.5.5.5"), /*validSeqNo*/ false, /*seqNo*/ 0,
                                             /*interface*/ iface, /*hop*/ 15, /*next hop*/ Ipv4Address ("1.1.1.1"), /*second hop*/Ipv4Address(),/*lifetime*/ Seconds (-10));
